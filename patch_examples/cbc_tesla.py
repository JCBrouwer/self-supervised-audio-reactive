...
os.environ["MIX"] = "teslafox_cbc_mIx"
os.environ["CKPT"] = "dohr-006"
# VERBOSE = True
    ...
    prms = [
        {
            ...
            "transition_window": int(round(fps / 4)),
        }
        for _ in range(len(tracks))
    ]

    prms[51]["drop_weight"] = 0.25
    prms[51]["high_noise_weight"] = 0.4
    prms[51]["low_noise_weight"] = 0.4

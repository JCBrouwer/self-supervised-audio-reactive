...
os.environ["MIX"] = "tsou_cbc"
os.environ["CKPT"] = "animacht2-148"
# VERBOSE = True
...
if __name__ == "__main__":
    ...
    metadata_file = f"/home/hans/code/audioreac/workspace/{main_audio_file.split('/')[-1].split('.')[0]}_metadata.json"
    intro_file = f"/home/hans/code/audioreac/workspace/{file_root}_intro_latents.npy"
    drop_file = f"/home/hans/code/audioreac/workspace/{file_root}_drop_latents.npy"
    latent_file = f"/home/hans/code/audioreac/workspace/{file_root}_latents.npy"
    noise_file = f"/home/hans/code/audioreac/workspace/{file_root}_noise.npy"
    print(checkpoint)
    print(main_audio_file)
    print(metadata_file)
    print(intro_file)
    print(drop_file)
    print(latent_file)
    ...
    prms[0]["high_noise_weight"] = 0.2
    prms[0]["low_noise_weight"] = 0.3
    prms[0]["intro_loop_smoothing"] = 80
    prms[0]["drop_loop_smoothing"] = 32
    prms[0]["freq_latent_weight"] = 0.25
    prms[0]["high_freq_latent_weight"] = 0.25
    prms[0]["freq_latent_smooth"] = 20
    prms[0]["high_freq_latent_smooth"] = 20
    prms[0]["rms_smooth"] = 20
    prms[0]["bass_smooth"] = 20
    prms[0]["onset_smooth"] = 20

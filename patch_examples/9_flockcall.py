...
dict(title="1st Movement", start=21 * 60 + 32, end=22 * 60 + 21)
dict(title="2nd Movement", start=22 * 60 + 21, end=23 * 60 + 41)
from .base import *
...
def initialize(args):
    ...
    args.drum_onsets = ar.gaussian_filter(args.drum_onsets, 3, causal=0.25)
...
def get_latents(selection, args):
    ...
    drop_latents = ar.slerp_loops(drop_selection, args.n_frames, args.bpm / 60 * args.duration / 8, smoothing=6)

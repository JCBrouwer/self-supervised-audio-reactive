...
os.environ["MIX"] = "galva_cbc_mix"
os.environ["CKPT"] = "dohr-314"
# VERBOSE = True
...
if __name__ == "__main__":
    ...
    prms = [
        {
            ...
            "intro_loop_factor": 0.5,
            "drop_num_beats": 32,
            "drop_loop_smoothing": 16,
            "drop_loop_factor": 0.55,
            "onset_smooth": 1,
            "onset_clip": 80,
            "freq_mod": 15,
            "freq_mod_offset": 0,
            "freq_smooth": 6,
            "freq_latent_smooth": 7,
            "freq_latent_layer": 1,
            "freq_latent_weight": 4,
            "high_freq_mod": 10,
            "high_freq_mod_offset": 0,
            "high_freq_smooth": 3,
            "high_freq_latent_smooth": 6,
            "high_freq_latent_layer": 0,
            "high_freq_latent_weight": 5,
            "rms_smooth": 5,
            "bass_smooth": 6,
            "bass_clip": 90,
            "drop_clip": 75,
            ...
            "transition_window": int(round(fps / 2)),
        }
        for _ in range(len(tracks))
    ]
    prms[0]["drop_clip"] = 60

    prms[14]["intro_num_beats"] = 128
    prms[14]["intro_loop_smoothing"] = 48
    prms[14]["intro_loop_factor"] = 0.15
    prms[14]["drop_num_beats"] = 128
    prms[14]["drop_loop_smoothing"] = 48
    prms[14]["drop_loop_factor"] = 0.15
    prms[14]["drop_weight"] = 0.4
    prms[14]["onset_smooth"] = 4

    prms[15]["intro_num_beats"] = 128
    prms[15]["intro_loop_smoothing"] = 48
    prms[15]["intro_loop_factor"] = 0.15
    prms[15]["drop_num_beats"] = 128
    prms[15]["drop_loop_smoothing"] = 48
    prms[15]["drop_loop_factor"] = 0.15
    prms[15]["drop_weight"] = 0.4
    prms[15]["onset_smooth"] = 4

    prms[16]["intro_num_beats"] = 128
    prms[16]["intro_loop_smoothing"] = 48
    prms[16]["intro_loop_factor"] = 0.15
    prms[16]["drop_num_beats"] = 128
    prms[16]["drop_loop_smoothing"] = 48
    prms[16]["intro_loop_factor"] = 0.15
    prms[16]["freq_latent_smooth"] = 12
    prms[16]["high_freq_latent_smooth"] = 8
    prms[16]["drop_clip"] = 99
    prms[16]["drop_weight"] = 0.3
    prms[16]["onset_clip"] = 99
    prms[16]["onset_smooth"] = 5
    prms[16]["high_noise_weight"] = 2
    prms[16]["low_noise_weight"] = 1
    ...
    if not eval(os.environ["RENDER"]):
        ...
        latents = th.from_numpy(causal_gaussian(latents, [3.5 * smf, 0, 0]))

...
# np.savez_compressed(f"cache/SGWs_dur{duration}_fps{fps}.npz", names=names, vids=vids, auds=auds, sgws=sgws)
# file = np.load(f"cache/SGWs_dur{duration}_fps{fps}.npz")
# names, vids, auds, sgws = file["names"], file["vids"], file["auds"], file["sgws"]
